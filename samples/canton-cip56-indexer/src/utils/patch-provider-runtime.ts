 ...
 *
 * Usage:
 *   RUNTIME_NAME=my-runtime IMAGE_REPOSITORY=samples/canton-cip56-indexer npm run patch-provider-runtime
 */
...
const runtimeName = process.env.RUNTIME_NAME ?? 'canton-cip56-indexer-runtime';
const runtimeImageRepository = process.env.IMAGE_REPOSITORY ?? 'samples/canton-cip56-indexer';
