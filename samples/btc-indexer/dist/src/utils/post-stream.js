...
/**
 * Utility script: create the BTC event stream in the Workflow Engine.
 *
...
import { stream } from '../bitcoin/stream.js';
dotenv.config();
const config = ConfigLoader.loadClientConfigFromFile(process.env.WFE_CONFIG_FILE ?? './config/wfe-config.yaml');
