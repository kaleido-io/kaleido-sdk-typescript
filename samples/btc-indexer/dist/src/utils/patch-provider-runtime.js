 ...
 *
 * Usage:
 *   RUNTIME_NAME=my-runtime IMAGE_REPOSITORY=samples/bitcoin-indexer npm run patch-provider-runtime
 */
...
const runtimeName = process.env.RUNTIME_NAME ?? 'bitcoin-indexer-runtime';
const runtimeImageRepository = process.env.IMAGE_REPOSITORY ?? 'samples/bitcoin-indexer';
