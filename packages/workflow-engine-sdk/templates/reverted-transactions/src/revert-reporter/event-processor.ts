...
export class RevertReporterEventProcessor {

    constructor() { }

    name(): string {
        return 'revert-reporter';
    }
    ...
    eventProcessorBatch(result: WSEventProcessorBatchResult, batch: WSEventProcessorBatchRequest): Promise<void> {
        console.log(`Event processor batch received: ${batch.events.length} events`);
...
export const revertReporterEventProcessor = new RevertReporterEventProcessor();
